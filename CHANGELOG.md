# uccx-12-5-toolbox-ui Change Log
...
### Fixes
* **Provision:** Allow provisioning again after a provisioning error.


# 2021.6.29-1

### Fixes
* **Site:** Fixed error message display data.
...
### Fixes
* **Agents:** Add missing RDP username to agents information.


# 2021.4.28-2

### Fixes
* **Deploy:** Fix deployment update issue with yarn.lock file.
...
### Fixes
* **Reset Password:** Show notifications when resetting the VPN password.
